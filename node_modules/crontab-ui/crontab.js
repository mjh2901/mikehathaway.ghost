...
exports.set_crontab = function(env_vars, callback) {
	exports.crontabs( function(tabs){
		...
		fs.writeFile(exports.env_file, env_vars, function(err) {
			...
			fs.writeFile(path.join(exports.cronPath, fileName), crontab_string, function(err) {
				if (err) {
					console.error(err);
					return callback(err);
				}

				exec("crontab " + path.join(exports.cronPath, fileName), function(err) {
					if (err) {
						console.error(err);
						return callback(err);
					}
